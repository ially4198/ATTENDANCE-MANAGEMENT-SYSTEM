...
const CourseRegistration = () => {
  ...
  const filteredCourses = availableCourses.filter((course) => {
    ...
    const matchesAcademicLevel =
      ...
      course.academicLevel === academicLevelFilter;
  ...
  const departments = [
    "all",
    ...new Set(availableCourses.map((c) => c.department)),
  ];
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2 text-sm sm:text-base">
          Browse and register for courses for this semester
        </p>
      </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                Normal course load is 12-18 credits per semester. Contact your
                advisor for exceptions.
              </p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                Courses are filled on a first-come, first-served basis. Register
                early to secure your preferred courses.
              </p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                You may add or drop courses until the published deadline. Late
                changes require instructor approval.
              </p>
            </div>
          </div>
        </div>
