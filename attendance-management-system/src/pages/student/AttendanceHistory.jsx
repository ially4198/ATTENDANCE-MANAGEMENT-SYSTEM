...
const AttendanceHistory = () => {
  ...
  const filteredRecords = attendanceRecords.filter((record) => {
    ...
    const recordMonth = new Date(record.date).toLocaleString("en-US", {
      month: "2-digit",
      year: "numeric",
    });
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
                <div className="text-left sm:text-right">
                  ...
                  <p className="text-xs text-gray-600">
                    {course.present}/{course.present + course.absent} classes
                  </p>
                </div>
        ...
        <div className="space-y-3">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800">
                You must maintain at least 75% attendance to be eligible for
                course completion.
              </p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800">
                Medical certificates or exceptional circumstances must be
                reported to your instructor within 48 hours.
              </p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800">
                Contact your course instructor or the academic office for
