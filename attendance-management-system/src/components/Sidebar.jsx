...
const Sidebar = () => {
        ...
        // Allow external components (e.g. Navbar) to toggle the sidebar via a global event
        useEffect(() => {
        ...
        return (
                <>
                        ...
                        {/* Sidebar */}
                        <aside
                                className={`fixed md:static top-0 left-0 h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white shadow-lg flex flex-col transition-transform duration-300 z-40 ${isCollapsed ? '-translate-x-full md:translate-x-0' : 'translate-x-0'
                        ...
                        >
                                ...
                                {/* Footer Info */}
                                <div className={`p-4 border-t border-slate-700 bg-slate-900 ${isCollapsed && !isMobile ? 'text-center' : ''}`}>
                                        {!(isCollapsed && !isMobile) && (
